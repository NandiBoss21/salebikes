...
export const metadata: Metadata = {
  title: 'Gravel kerékpárok | Bringabarát – Kápolnásnyék',
  description: 'Outlet és használt gravel kerékpárok garanciával. Prémium gravel bike-ok kedvező áron. Kápolnásnyék, Velence, személyes megtekintés.',
  alternates: { canonical: 'https://testbikevelence.hu/gravel' },
}

const categoryData = {
  label: 'Kápolnásnyék · Velence · 50 km Budapesttől',
  h2line1: 'Gravel kerékpárok.',
...
export default function GravelPage() {
  return (
    <>
      <CategoryPage category="gravel" label="Gravel" />
      <section style={{
        background: '#111111',
