...
export const metadata: Metadata = {
  title: 'Gyerek kerékpárok | Bringabarát – Kápolnásnyék',
  description: 'Outlet és használt gyerek kerékpárok garanciával. Minőségi gyerekbringák kedvező áron. Kápolnásnyék, Velence, Budapesttől 50 km.',
  alternates: { canonical: 'https://testbikevelence.hu/gyerek' },
}

const categoryData = {
  label: 'Kápolnásnyék · Velence · 50 km Budapesttől',
  h2line1: 'Gyerek kerékpárok.',
...
export default function GyerekPage() {
  return (
    <>
      <CategoryPage category="gyerek" label="Gyerek" />
      <section style={{
        background: '#111111',
