...
export const metadata: Metadata = {
  title: 'Elektromos kerékpárok (Ebike) | Bringabarát – Kápolnásnyék',
  description: 'Outlet és használt elektromos kerékpárok garanciával. Cube, Bulls, KTM, Giant e-bike-ok bolti ár töredékéért. Kápolnásnyék, Velence, Budapesttől 50 km.',
  alternates: { canonical: 'https://testbikevelence.hu/ebike' },
}

const categoryData = {
  label: 'Kápolnásnyék · Velence · 50 km Budapesttől',
  h2line1: 'Elektromos kerékpárok.',
...
export default function EbikePage() {
  return (
    <>
      <CategoryPage category="ebike" label="Ebike" />
      <section style={{
        background: '#111111',
