...
export const metadata: Metadata = {
  title: 'Hegyi kerékpárok (MTB) | Bringabarát – Kápolnásnyék',
  description: 'Outlet és használt mountain bike-ok garanciával. Scott, Cube, Cannondale MTB kerékpárok kedvező áron. Kápolnásnyék, Velence, személyes megtekintés.',
  alternates: { canonical: 'https://testbikevelence.hu/mtb' },
}

const categoryData = {
  label: 'Kápolnásnyék · Velence · 50 km Budapesttől',
  h2line1: 'Hegyi kerékpárok.',
...
export default function MtbPage() {
  return (
    <>
      <CategoryPage category="mtb" label="MTB" />
      <section style={{
        background: '#111111',
