...
export const metadata: Metadata = {
  title: 'Trekking kerékpárok | Bringabarát – Kápolnásnyék',
  description: 'Outlet és használt trekking kerékpárok garanciával. Cube, Scott, Giant trekking bringák kedvező áron. Kápolnásnyék, Velencei-tó mellett.',
  alternates: { canonical: 'https://testbikevelence.hu/trekking' },
}

const categoryData = {
  label: 'Kápolnásnyék · Velence · 50 km Budapesttől',
  h2line1: 'Trekking kerékpárok.',
...
export default function TrekkingPage() {
  return (
    <>
      <CategoryPage category="trekking" label="Trekking" />
      <section style={{
        background: '#111111',
